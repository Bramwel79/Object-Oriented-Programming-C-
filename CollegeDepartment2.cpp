...
int main()
{
    ...
    CollegeDepartment cMost;
    CollegeDepartment cFewest;
    int most;
    int fewest;
    string dept;
    string chair;
    ...
    //do comparison
    cFewest = collegeDepts[0];
    cMost = collegeDepts[0];
    for(i = 0; i < SIZE; ++i)
    {
       if(collegeDepts[i] < cFewest)
       {
           cFewest = collegeDepts[i];
       }
       if(collegeDepts[i] > cMost)
       {
           cMost = collegeDepts[i];
       }
    ...
    cout <<"\n";
    cout <<"The object with largest number of classes is " << endl;
    cout <<"*********************************************"<<endl;
    cout << cMost;
    cout <<"\n";
    cout <<"The object with fewest number of classes is " << endl;
    cout <<"**********************************************"<<endl;
    cout << cFewest;
