...
int main()
{
    ...
    highestBalance = barclay[0].accountBalance;
    lowestBalance = barclay[0].accountBalance;
    ...
    for(x = 1; x < 5; ++x)
    {
        ...
        if(barclay[x].accountBalance < lowestBalance)
        {
            lowestBalance = barclay[x].accountBalance;
        }

        if(barclay[x].accountBalance > highestBalance)
        {
            highestBalance = barclay[x].accountBalance;
        }
    ...
    cout << "\n";
    cout <<"Lowest bank balance is " <<lowestBalance<<endl;
    cout <<"Highest bank balance is " <<highestBalance<<endl;
    return 0 ;
